...
- **Weapons age backward**: pick a starting arm (弓/劍/矛/刀), already cast in bronze so nothing reads as a modern font; duplicates recast it toward 甲骨文 — a 弓 becomes 射, the arrow on the string.
